...
public class DbUtils {
	...
	private final static String createAlbum="CREATE TABLE ALBUM ("+"ID INTEGER GENERATED BY DEFAULT AS IDENTITY,"+ "CODEALBUM INTEGER NOT NULL,"+"NOM CHAR(25) NOT NULL,"+"ARTISTEID INTEGER NOT NULL,"+"PRIMARY KEY(ID)"+")";
	private final static String createChanson="CREATE TABLE CHANSON ("+"ID INTEGER GENERATED BY DEFAULT AS IDENTITY,"+"CODECHANSON INTEGER NOT NULL,"+"NOM CHAR(25) NOT NULL,"+"DUREE INTEGER NOT NULL,"+"ALBUMID INTEGER NOT NULL,"+"PRIMARY KEY(ID)"+")";
			...
			for(Map.Entry<Artiste, HashMap<Album, Chanson>> mapArtisteAlbumChanson :toWrite.entrySet()){
				...
				if (albumChansonHash!=null){
					for(Map.Entry<Album,Chanson> mapAlbumChanson:albumChansonHash.entrySet()){
						mapArtisteAlbumChanson.getKey().addAlbum(mapAlbumChanson.getKey());
						mapAlbumChanson.getKey().addChanson(mapAlbumChanson.getValue());
					}
				}
				session.save(mapArtisteAlbumChanson.getKey());
			}
		}
